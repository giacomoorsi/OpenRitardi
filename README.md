...
The dataset requires some pre-processing because of its size, and since its format is not optimal for visualisations. Nevertheless, we already did all the necessary data wrangling to be able to start working on the visuals.
